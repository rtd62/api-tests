...
if(isset($_POST["code"])){
  ...
  $ch = curl_init();
  // Set url elements
  $fb_app_id = '746459578850470';
  $ak_secret = 'ebfe028d89e2924af4a61b809cef0e9b';
...
<head>
  ...
  <link rel="stylesheet" href="assets/css/ak.css">
  <!--Hotlinked Account Kit SDK-->
  <script src="https://sdk.accountkit.com/us_EN/sdk.js"></script>
</head>
...
?>
<h1 class="ac">Login with Account Kit</h1>
<p class="ac">The session with Facebook Account Kit has begun.</p>
...
<p class="ac">
  ...
  <strong>Phone Number:</strong> <?=$final->phone->national_number?> <br>
  <?php
  }
  ?>  
</p>
